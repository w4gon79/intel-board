...
export function AppShell(): React.JSX.Element {
  ...
  return (
    ...
    <div className="flex min-h-0 flex-col bg-zinc-950 text-zinc-100 h-auto min-h-screen xl:h-full">
      <HeaderBar onOpenSettings={openSettings} onOpenAI={openAI} />
      <StatusBar layers={layers} />
      <div className="flex flex-col gap-2 p-2 xl:flex-row xl:flex-1 xl:min-h-0 xl:overflow-y-hidden">
        <section
